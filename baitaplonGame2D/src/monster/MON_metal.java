...
public class MON_metal extends Entity {
	GamePanel gp;
	public MON_metal(GamePanel gp) {
		super(gp);
		this.gp = gp;
		type = 2;
		name = "metalKnight";
	...
	public void getImage() {
		...
		anim = CacheDataLoader.getInstance().getAnimation("monsmove");
		anim1 = CacheDataLoader.getInstance().getAnimation("monsdie");
	}
		...
		if (worldX + gp.tileSize > gp.player.worldX - gp.player.screenX
			...
			if (life <= 0) {
				...
				if (anim1.isLastFrame() == false) {
					...
					anim1.draw(screenX, screenY, g2, gp.tileSize * 2, gp.tileSize * 2);
				}
				...
				anim.draw(screenX, screenY, g2, gp.tileSize * 2, gp.tileSize * 2);
			}
			// DRAW HP BAR
			if (hpBarOn == true) {
