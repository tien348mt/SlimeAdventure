...
public class Animation {
	...
	private ArrayList<FrameImage> frameImages;// Arraylist has getter and setter
    ...
    public boolean isIgnoreFrame(int id){	//check image is ignore or not if true skip image
        return ignoreFrames.get(id);
    }
    
    public void setIgnoreFrame(int id){//check image want to ignore
    ...
    public void draw(int x, int y, Graphics2D g2,int size1, int size2){
